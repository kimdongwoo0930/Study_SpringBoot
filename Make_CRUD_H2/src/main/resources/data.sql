...
-- article 더미 테이터
INSERT INTO article(id,title,content) VALUES(4,'당신의 영화','ㄷ');
INSERT INTO article(id,title,content) VALUES(5,'당신의 소울','대');
INSERT INTO article(id,title,content) VALUES(6,'당신 취미','댓');
